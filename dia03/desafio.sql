...
CREATE DATABASE desafio_carlos_urrutia_123;

\c desafio_carlos_urrutia_123; --  Ahora está conectado a la base de datos
...
INSERT INTO clientes (email, nombre, telefono, empresa, prioridad) VALUES
    ('cliente1@example.com', 'juanita Perez', '56992343423', 'Empresa A', 5),
    ('cliente2@example.com', 'pedro Piedra', '56998765432', 'Empresa B', 8),
    ('cliente3@example.com', 'anita Soto', '56991122233', 'Empresa C', 10),
    ('cliente4@example.com', 'Pablo Neruda', '56991155566', 'Empresa C', 9),
    ('cliente5@example.com', 'Marcelo salas', '56997232891', 'Empresa A', 7);
